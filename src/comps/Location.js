...
export default function Location({ onSearch, weather, bg }) {
  ...
  return (
    <div className="lg:h-screen lg:w-[65%] w-full flex flex-col items-center justify-center gap-1 lg:p-2">
      {/* Location */}
      <div
        className="w-full min-h-[70vh] lg:h-[70vh] lg:rounded-xl flex flex-col justify-start gap-4 lg:gap-0 lg:justify-between p-4"
        style={{
          backgroundImage: `linear-gradient(90deg, #33333340, #33333340), url(${bg()})`,
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          {weather && weather.city && (
            <h1 className="p-1 flex items-center gap-[1ch] justify-center lg:justify-start">
        ...
        {weather && weather.list && (
          <div
            className="flex flex-col gap-4 py-2 px-4 bg-[#ffffff05] "
            style={{
